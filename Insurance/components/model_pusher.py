...
from Insurance.entity.artifact_entity import DataTransformationArtifact,ModelPusherArtifact,ModelTrainingArtifact
...
#load object
            ...
            model = load_object(file_path=self.model_training_artifact.model_path)
